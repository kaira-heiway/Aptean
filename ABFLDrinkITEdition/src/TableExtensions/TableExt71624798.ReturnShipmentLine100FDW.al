tableextension 71624798 ReturnShipmentLine100FDW extends "Return Shipment Line"
{
    fields
    {
        ...
        field(71624770; "Qty. Transport Units 101FDW"; Decimal)
        {
        ...
        field(71624777; "Loan In Use Item Sales 101FDW"; Boolean)
        {
            Caption = 'Loan In Use Item (Purch.)';
        }
